        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-h1 text-primary-text mb-6">
              O'zbekiston bo'ylab yuklaringizni ishonchli yetkazib beramiz!
            </h1>
            <p className="text-body text-secondary-text mb-10 max-w-xl">
              OMON LOGISTICS – 20 yillik tajribaga ega logistika kompaniyasi.
              Biz yuklaringizni O'zbekiston bo'ylab xavfsiz, tez va samarali
              yetkazamiz.
            </p>
          ...
          {/* hidden lg:block -> block (barcha ekranlarda ko'rinadi) */}
          <motion.div
          ...
          >
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              <div className="absolute inset-0 bg-linear-to-tr from-primary/20 to-info/20 rounded-[40px] rotate-6 scale-105 blur-xl"></div>
              ...
              >
                ...
                <div>
                  <p className="text-small font-bold text-primary-text">
                    100% Kafolat
                  </p>
